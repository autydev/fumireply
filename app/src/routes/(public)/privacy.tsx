...
export const Route = createFileRoute('/(public)/privacy')({
  head: () => ({
    meta: [
      { title: 'プライバシーポリシー — Fumireply' },
      { name: 'description', content: 'Fumireply（運営: 株式会社Malbek）のプライバシーポリシー' },
    ],
  }),
  ...
  return (
    <PublicShell>
      <main className="public-page">
        ...
        <p>
          株式会社Malbek（以下「当社」）は、Fumireply（以下「本サービス」）において取得する個人情報の取り扱いについて、以下のとおりプライバシーポリシーを定めます。
        </p>
